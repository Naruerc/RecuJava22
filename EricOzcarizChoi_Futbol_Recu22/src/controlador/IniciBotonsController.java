...
public class IniciBotonsController extends Application {
	...
	private void onAction(ActionEvent e) throws Exception {
		...
		}else if(e.getSource() == btnDivisiones){//verifica si el botón es igual al que llamo al evento	
			changeScene("/vista/JugadoresView.fxml", "Divisiones");
		}else if(e.getSource() == btnEquipos){//verifica si el botón es igual al que llamo al evento	
...
//		});
		...
		if(title.equalsIgnoreCase("Jugadores")) {
			...
			jugadoresC.setConexionBD(conexionBD);
